...
- :Transmission:
    Add support for setting the download client's timeout. This involves adding support
    for configuring each download client individually, as opposed to only a list of
    URLs, and as such requires a configuration change::
      ...
      download-clients:
        Transmission:
...
- :Python:
    Upgrade all requirements to the most recent versions as of Tue Oct 31 05:01:35 PM
    UTC 2023.
...
- :Python:
    Update `the Python versions <https://www.python.org/downloads/>`_ this package
    supports. Remove v3.7 support and add v3.12 support.
- :Python:
...
- :Transmission:
    Normalize the port in download client URLs so that they match regardless of whether
    the default port for the protocol or scheme, ``80`` vs ``443``, is specified.
- :Servarr:
    Stop depending on Servarr for download client authentication, requires configuration
    changes. Radarr no longer returns passwords from the download client API endpoint.
    Following their lead, stop depending on the Servarr APIs to provide authentication
    credentials and get the Transmission RPC password from the Prunerr configuration::
    ...
    download-clients:
      urls:
    ...
    ...
- :Review:
    Tolerate connection timeouts with external services when performing review actions
    on a per-item basis to minimize the interruptions from intermittent errors.
- :Python:
    Upgrade all requirements to the most recent versions as of Sun Oct 29 06:24:32 PM
    UTC 2023.
...
- :Python:
    Upgrade all requirements to the latest versions as of Wed May 10 06:49:51 PM
    UTC 2023.
...
- :Python:
    Upgrade all requirements to the latest versions as of Tue May 9 09:31:01 PM
    UTC 2023.
...
- :Python:
    Upgrade all requirements to the latest versions as of Sun May 7 09:27:36 AM
    UTC 2023.
...
- :Python:
    Upgrade all requirements to the latest versions as of Fri May 5 01:58:13 PM
    UTC 2023.
...
- :Python:
    Upgrade all requirements to the latest versions as of Wed Apr 26 05:24:13 PM
    UTC 2023.
...
- :Python:
    Upgrade all requirements to the latest versions as of Tue Apr 25 11:00:28 PM
    UTC 2023.
...
- :Python:
    Upgrade all requirements to the latest versions as of Sun Apr 16 03:54:21 PM
    UTC 2023.
...
- :Python:
    Upgrade all requirements to the latest versions as of Sat Apr 15 06:11:17 PM
    UTC 2023.
...
- :Python:
    Upgrade all requirements to the latest versions as of Tue Apr 11 08:15:25 PM
    UTC 2023.
...
- :Python:
    Upgrade all requirements to the latest versions as of Sun Apr  9 11:19:15 PM
    UTC 2023.
